...
If the command doesn't report an LTS version of Node.js (e.g., v18.17.1), it means you don't have a suitable version of Node.js installed.
...
To make Node.js 18 the default in new terminals, type:
