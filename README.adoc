...
ui:
  bundle:
    url: https://github.com/stephengold/antora-ui-bundle/releases/download/v-sgold240101a/ui-bundle.zip
    snapshot: true
----
...
If the command doesn't report an LTS version of Node.js (e.g., v20.15.0), it means you don't have a suitable version of Node.js installed.
